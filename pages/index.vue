              ...
              <ul id="bna" class="of">
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="Java" class="course-title fsize18 c-333">Java</a>
                    </h3>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="Linux" class="course-title fsize18 c-333">Linux</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      ...
                      >
                      <div class="cc-mask">
                        <a href="#" title="开始学习" class="comm-btn c-btn-1">Start</a>
                      </div>
                    </section>
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="C4D零基础" class="course-title fsize18 c-333">C4D</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">免费</i>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="数学给宝宝带来的兴趣" class="course-title fsize18 c-333">RBAC</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">免费</i>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="MySql从入门到精通" class="course-title fsize18 c-333">Data Structure</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">免费</i>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="搜索引擎优化技术" class="course-title fsize18 c-333">IT Interviews</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">免费</i>
                ...
                <li>
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="20世纪西方音乐" class="course-title fsize18 c-333">java11</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span class="fr jgTag bg-green">
                        <i class="c-fff fsize12 f-fA">免费</i>
                ...
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/college/1" title="UPV">
                        <img alt="陈伟霆" src="~/assets/photo/college/UPV.jpg" width="142">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/college/1" title="UPV" class="fsize18 c-666">UPV</a>
                    </div>
                  </section>
                </li>
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/college/1" title="UC3M">
                        <img alt="周润发" src="~/assets/photo/college/UC3M.png" width="142">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/college/1" title="UC3M" class="fsize18 c-666">UC3M</a>
                    </div>
                  </section>
                </li>
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/college/1" title="Oxford">
                        <img alt="周杰伦" src="~/assets/photo/college/Oxford.png" width="142">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/college/1" title="Oxford" class="fsize18 c-666">Oxford</a>
                    </div>
                  </section>
                </li>
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/college/1" title="Cambridge">
                        <img alt="刘德华" src="~/assets/photo/college/Cambridge.png" width="142">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/college/1" title="Cambridge" class="fsize18 c-666">Cambridge</a>
                    </div>
                  </section>
                </li>
              </ul>
